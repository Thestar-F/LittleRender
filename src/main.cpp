...
int main(int argc, char *argv[])
{
    ...
    shared_ptr<Model> model = make_shared<Model>("D:/c++/GUI-MyRender/MyRender/assets/monster/diablo3_pose.obj");


    TGAImage Diffuse;
    Diffuse.read_tga_file("D:/c++/GUI-MyRender/MyRender/assets/monster/diablo3_pose_diffuse.tga");
    Diffuse.flip_vertically();

    TGAImage Metallic;
    Metallic.read_tga_file("D:/c++/GUI-MyRender/MyRender/assets/monster/helmet_metalness.tga");
    Metallic.flip_vertically();

    TGAImage Normal;
    Normal.read_tga_file("D:/c++/GUI-MyRender/MyRender/assets/monster/diablo3_pose_nm_tangent.tga");
    Normal.flip_vertically();

    TGAImage Roughness;
    Roughness.read_tga_file("D:/c++/GUI-MyRender/MyRender/assets/monster/helmet_roughness.tga");
    Roughness.flip_vertically();

    TGAImage Emission;
    Emission.read_tga_file("D:/c++/GUI-MyRender/MyRender/assets/monster/diablo3_pose_glow.tga");
    ...
    M.c2p = pers_projection(0.01, 100, WH_ratio, 45);
    ...
    Shadow_M.c2p = orth_projection(-2, 2, -2, 2, 0.01, 100, WH_ratio);
    Shadow_M.vp = viewport(Width, Height);

    mat<4, 4> W2L = Shadow_M.vp * Shadow_M.c2p * Shadow_M.w2c;
    mat<4, 4> C2L = W2L * (M.w2c).invert();
    M.toSmap = C2L;
